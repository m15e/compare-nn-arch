...
def calculates_results_stats(results_dic):
    ...
    """        
    #nd is short for not dog
    results_stats_dic = { 'n_images': len(results_dic), 'n_correct_dogs': 0, 'n_dogs_img': 0, 'n_correct_notdogs': 0, 'n_notdogs_img': 0, 'n_correct_breed': 0, 'n_correct_label': 0, 'n_match': 0, 'pct_correct_dogs': 0, 'pct_correct_notdogs': 0, 'pct_correct_breed': 0, 'pct_match': 0 }

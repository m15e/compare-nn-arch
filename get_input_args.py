...
def get_input_args():
    ...
    # Argument 1: folder containing images
    ...
    # Argument 3: file containing valid names
    parser.add_argument('--dogfile', type = str, default = 'dognames.txt', help = 'file containing image class names')
